...
<div style="position: relative; top: 10px; left: 40px;" id="remarkDivList">
    ...
    <c:forEach items="${customerRemarkList}" var="remark">
        <div class="remarkDiv" style="height: 60px;" id="div_${remark.id}">
            <img title="${customer.owner}" src="image/headImg.jpg" style="width: 30px; height:30px;">
        ...
        <div style="position: relative;top: 0px;">
            <table id="activityTable" class="table table-hover" style="width: 900px;">
                ...
                <c:forEach items="${contactsList}" var="contacts">
                    <tr>
                        <td><a href="../contacts/detail.html" style="text-decoration: none;">${contacts.fullname}</a>
                        </td>
