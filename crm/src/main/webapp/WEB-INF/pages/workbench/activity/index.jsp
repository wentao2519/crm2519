    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#exportActivityXzBtn").click(function () {
                ...
                // 发同步请求
                window.location.href = "workbench/activity/exportAllActivityByIds.do?"+ids;
            });
            // 导入市场活动按钮的点击事件
            $("#importActivityBtn").click(function () {
                var activityFileName = $("#activityFile").val();// 文件名
                var suffix = activityFileName.substr(activityFileName.lastIndexOf(".")+1).toLocaleLowerCase();//文件后缀名
                if (suffix != "xls"){
                    alert("导入市场活动，只支持xls文件！")
                    return;
                }

                var activityFile = $("#activityFile")[0].files[0];
                if (activityFile.size>5*1024*1024){
                    alert("导入市场活动，文件大小不能超过5MB！")
                    return;
                }
                ...
                $.ajax({
                    ...
                    data:formData,
                    processData:false, //设置ajax向后台发送请求前，是否把参数统一转换成字符串：true->是，false->不是 默认true
                    contentType:false, // 设置ajax向后台发送请求前，是否把所有参数统一按urlencoded编码：默认true
                    type:'post',
                    dataType:'json',
                    success:function (data) {
                        if (data.code == "1"){
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control mydate" id="edit-startDate" name="mydate" readonly value="2020-10-10">
                        </div>
                        <label for="edit-endDate" class="col-sm-2 control-label " >结束日期</label>
                        <div class="col-sm-10" style="width: 300px;">
                            <input type="text" class="form-control mydate" id="edit-endDate" value="2020-10-20" name="mydate" readonly>
                        </div>
                    </div>
            ...
            <form class="form-inline" role="form" style="position: relative;top: 8%; left: 5px;">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input class="form-control mydate" type="text" readonly id="query-startDate"/>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group">
                        <div class="input-group-addon">结束日期</div>
                        <input class="form-control mydate" type="text" readonly id="query-endDate">
                    </div>
                </div>
