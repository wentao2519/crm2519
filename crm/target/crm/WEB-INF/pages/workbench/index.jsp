...
<script type="text/javascript">
	...
	$(function(){
		...
		// 修改密码按钮 单击事件
		$("#modifyLoginPwdBtn").click(function () {

			$("#modifyLoginPwdForm").get(0).reset();

			$("#editPwdModal").modal("show");
		});

		// 更新按钮 单击事件
		$("#saveModifyLoginPwdBtn").click(function () {

			var originalPwd = $.trim($("#originalPwd").val());
			...
			$.ajax({
				url:'settings/qx/user/modifyLoginPwd.do',
				data:{
...
<body>
	...
	<div class="modal fade" id="editPwdModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 70%;">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form class="form-horizontal" role="form" id="modifyLoginPwdForm">
						<div class="form-group">
							<label for="originalPwd" class="col-sm-2 control-label">原密码</label>
							<div class="col-sm-10" style="width: 300px;">
								<input type="password" class="form-control" id="originalPwd" style="width: 200%;">
							</div>
						</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary"  id="saveModifyLoginPwdBtn">更新</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
		<div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">CRM &nbsp;<span style="font-size: 12px;">&copy;2022&nbsp;waves</span></div>
